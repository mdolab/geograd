...
def helper_test_derivatives_translate_object_fd(
    testcase, objp0, objp1, objp2, smp0, smp1, smp2, direction, value, test_first=True
):
    result = g.compute(objp0, objp1, objp2, smp0, smp1, smp2, 0.001, 10)
    perim = result[1]
...
def helper_test_derivatives_translate_object_given(
    testcase, objp0, objp1, objp2, smp0, smp1, smp2, direction, value, test_first=True, tol=1e-7
):
    result = g.compute(objp0, objp1, objp2, smp0, smp1, smp2, 0.001, 10)
    perim = result[1]
