...
\qquad Last year, I implemented the computation of Equation~\ref{ks_geom} using the Tensorflow framework~\cite{tensorflow2015-whitepaper}. % cite tensorflow
...
\qquad I used my implementation, which I call \emph{geograd} (for ``\emph{geo}metric constraints with \emph{grad}ients''), for several published optimization studies over the last 12 months~\cite{Brelje2019a,Brelje2019c}. %cite scitech, aviation papers
...
\qquad I implemented the line-line and point-triangle tests as described in Ericson~\cite{Ericson:2004:RCD:1121584}. % TODO cite ericson
