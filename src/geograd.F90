module geograd
    ...
    subroutine compute_derivs(KS, intersect_length, mindist, dKSdA1, dKSdB1, dKSdC1, dKSdA2, dKSdB2, dKSdC2, &
        ...
        integer :: tri_ind_1, tri_ind_2, minloc_index, is_less_flag ! loop indices
        ...
        real(kind=8), parameter :: rev_seed = 1.0
        ...
        dKSdB2 = 0
        dKSdC2 = 0
        base_exp_accumulator = 0
        deriv_exp_accumulator = 0
        cur_min_dist = 9.9e10
        ...
        do tri_ind_1 = 1, n1
            do tri_ind_2 = 1, n2
                ...
                dKSdA1(:, tri_ind_1) = -sum(dA1, 2)
                dKSdB1(:, tri_ind_1) = -sum(dB1, 2)
                dKSdC1(:, tri_ind_1) = -sum(dC1, 2)
                dKSdA2(:, tri_ind_2) = -sum(dA2, 2)
                dKSdB2(:, tri_ind_2) = -sum(dB2, 2)
                dKSdC2(:, tri_ind_2) = -sum(dC2, 2)
            end do
        end do
